...
<head>
    ...
    <title>The Shoe Factory || Login</title>
    ...
    <div class="container-fluid px-0">
        <div class="background">
            ...
            <div class="contentContainer">
                <form action="backendFiles/loginBack.php" method="post">
                    <div class="row login">
                        ...
                        <div class="col-12 my-1 "><input type="submit" name="" id="" value="Log In"></div>
                        <div class="col-12 text-center mt-2 mb-4 signupLink"><a href="signUp.php">If you do not have a
...
<script>
    ...
    document.getElementById('alertCancel').addEventListener('click', () => window.location.href = "login.php");
